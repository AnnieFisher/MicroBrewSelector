...
START TRANSACTION;
USE `beerdb`;
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (1, 'Bristol Brewing Company', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (2, 'Avalanche Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (3, 'Alpine Dog Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (4, 'Colorado Plus', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (5, 'Flying Dog Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (6, 'Fort Collins Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (7, 'Gravity Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (8, 'Great Divide Brewing Company', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (9, 'Left Hand Brewing Company', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (10, 'Odell Brewing Company', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (11, 'Avery Brewing Company', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (12, 'Oskar Blue\'s Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (13, 'Dry Dock', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (14, 'Station 26 Brewing', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (15, 'Colorado Golden Cider Company', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (16, 'Golden City Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (17, 'Aspen', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (18, 'New Belgium Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (19, 'Breckenridge Brewery', NULL);
INSERT INTO `brand` (`idbrand`, `brand_name`, `brand_image`) VALUES (20, 'Crazy Mountain Brewery', NULL);
